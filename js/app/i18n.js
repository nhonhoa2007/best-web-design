...
const TEXT = {
    vi: {
        ...
        "events.kicker": "Diễn đàn campus",
        "events.title": "Diễn đàn sự kiện VKU",
        "events.body": "Tạo chủ đề, đặt câu hỏi, chia sẻ thông báo và cùng thảo luận về các hoạt động trong campus.",
        "events.album": "Diễn đàn",
        "events.formTitle": "Tạo chủ đề mới",
        "events.postPhoto": "Đăng chủ đề",
        "events.eventName": "Tiêu đề",
        "events.eventNamePlaceholder": "Ví dụ: Ai tham gia Open Campus tuần này?",
        "events.photo": "Ảnh đính kèm",
        "events.choosePhoto": "Chọn ảnh",
        "events.noFileSelected": "Chưa chọn ảnh",
        "events.photoHelp": "Ảnh là tùy chọn, tối đa 20MB và sẽ được nén trước khi tải lên.",
        "events.caption": "Nội dung",
        "events.captionPlaceholder": "Viết nội dung muốn thảo luận...",
        "events.galleryTitle": "Chủ đề mới nhất",
        "events.emptyLogin": "Đăng nhập để tạo chủ đề và tham gia thảo luận.",
        "events.loadingGallery": "Đang tải diễn đàn...",
        "events.empty": "Chưa có chủ đề nào. Hãy mở cuộc thảo luận đầu tiên.",
        "events.loadError": "Không tải được diễn đàn. Vui lòng thử lại sau.",
        "events.previewAlt": "Ảnh đính kèm xem trước",
        "events.imageAlt": "Ảnh đính kèm cho {title}",
        "events.fallbackTitle": "Chủ đề campus",
        "events.saving": "Đang gửi...",
        "events.loadingThread": "Đang tải chủ đề...",
        "events.threadLoadError": "Không tải được chủ đề này.",
        "events.selectThread": "Chọn một chủ đề để xem thảo luận.",
        "events.noReplies": "Chưa có phản hồi nào.",
        "events.replies": "Phản hồi",
        "events.replyLabel": "Trả lời",
        "events.replyPlaceholder": "Viết phản hồi của bạn...",
        "events.replySubmit": "Gửi trả lời",
        "events.replySaving": "Đang gửi...",
        "events.replyNotificationBody": "Có phản hồi mới trong chủ đề \"{title}\".",
        "events.threadCount": "{count} chủ đề",
        "events.deleteThread": "Xóa chủ đề",
        "events.categoryLabel": "Danh mục",
        "events.category.all": "Tất cả",
        "events.category.event": "Sự kiện",
        "events.category.question": "Hỏi đáp",
        "events.category.club": "Câu lạc bộ",
        "events.category.notice": "Thông báo",
        "toast.needLoginEventPhoto": "Bạn cần đăng nhập để tham gia diễn đàn.",
        "toast.eventMissingFields": "Vui lòng nhập tiêu đề và nội dung chủ đề.",
        "toast.eventPhotoSaved": "Đã đăng chủ đề.",
        "toast.eventPhotoSaveError": "Không đăng được chủ đề.",
        "toast.eventLoadError": "Không tải được diễn đàn.",
        "toast.eventPhotoMax": "Ảnh đính kèm gốc tối đa 20MB.",
        "toast.eventReplyMissing": "Vui lòng nhập nội dung trả lời.",
        "toast.eventReplySaved": "Đã gửi trả lời.",
        "toast.eventReplySaveError": "Không gửi được trả lời.",
        "toast.eventThreadDeleted": "Đã xóa chủ đề.",
        "toast.eventThreadDeleteError": "Không xóa được chủ đề.",
        ...
        "leaderboard.more": "Xem thêm người chơi",
        ...
        "notification.forumReply": "Có phản hồi forum mới",
        ...
        "tour.photoHelp": "Ảnh gốc tối đa 20MB, hệ thống sẽ tự nén trước khi tải lên. Khi sửa bài, chọn ảnh mới để thay ảnh cũ.",
        "tour.cancel": "Hủy",
        "tour.saveMoment": "Lưu khoảnh khắc",
        "tour.mapArea": "Bản đồ khu vực",
        "tour.closeMap": "Đóng bản đồ",
        "tour.openMap": "Mở bản đồ",
        "tour.moreActions": "Mở menu thao tác",
        ...
        "toast.passwordResetSent": "Đã gửi email đặt lại mật khẩu. Vui lòng kiểm tra hộp thư.",
        ...
        "toast.avatarMax": "Avatar gốc tối đa 20MB.",
        ...
        "toast.photoMax": "Ảnh gốc tối đa 20MB.",
        "confirm.deleteMoment": "Xóa khoảnh khắc này?",
        "confirm.deleteForumThread": "Xóa chủ đề này?",
        ...
        "auth.error.resetEmailRequired": "Nhập email tài khoản trước khi đặt lại mật khẩu.",
    ...
    en: {
        ...
        "events.kicker": "Campus Forum",
        "events.title": "VKU event forum",
        "events.body": "Create topics, ask questions, share notices, and discuss campus activities together.",
        "events.album": "Forum",
        "events.formTitle": "Create a new topic",
        "events.postPhoto": "Post topic",
        "events.eventName": "Title",
        "events.eventNamePlaceholder": "Example: Who is joining Open Campus this week?",
        "events.photo": "Attachment image",
        "events.choosePhoto": "Choose image",
        "events.noFileSelected": "No image selected",
        "events.photoHelp": "Image is optional, up to 20MB, and will be compressed before upload.",
        "events.caption": "Content",
        "events.captionPlaceholder": "Write what you want to discuss...",
        "events.galleryTitle": "Latest topics",
        "events.emptyLogin": "Sign in to create topics and join discussions.",
        "events.loadingGallery": "Loading forum...",
        "events.empty": "No topics yet. Start the first discussion.",
        "events.loadError": "Could not load the forum. Please try again later.",
        "events.previewAlt": "Attachment preview image",
        "events.imageAlt": "Attachment for {title}",
        "events.fallbackTitle": "Campus topic",
        "events.saving": "Posting...",
        "events.loadingThread": "Loading topic...",
        "events.threadLoadError": "Could not load this topic.",
        "events.selectThread": "Select a topic to view the discussion.",
        "events.noReplies": "No replies yet.",
        "events.replies": "Replies",
        "events.replyLabel": "Reply",
        "events.replyPlaceholder": "Write your reply...",
        "events.replySubmit": "Send reply",
        "events.replySaving": "Sending...",
        "events.replyNotificationBody": "There is a new reply in \"{title}\".",
        "events.threadCount": "{count} topics",
        "events.deleteThread": "Delete topic",
        "events.categoryLabel": "Category",
        "events.category.all": "All",
        "events.category.event": "Event",
        "events.category.question": "Q&A",
        "events.category.club": "Club",
        "events.category.notice": "Notice",
        "toast.needLoginEventPhoto": "You need to sign in to join the forum.",
        "toast.eventMissingFields": "Please enter a title and content.",
        "toast.eventPhotoSaved": "Topic posted.",
        "toast.eventPhotoSaveError": "Could not post topic.",
        "toast.eventLoadError": "Could not load the forum.",
        "toast.eventPhotoMax": "Original attachment image is limited to 20MB.",
        "toast.eventReplyMissing": "Please enter a reply.",
        "toast.eventReplySaved": "Reply sent.",
        "toast.eventReplySaveError": "Could not send reply.",
        "toast.eventThreadDeleted": "Topic deleted.",
        "toast.eventThreadDeleteError": "Could not delete topic.",
        ...
        "leaderboard.more": "View more players",
        ...
        "notification.forumReply": "New forum reply",
        ...
        "tour.photoHelp": "Original image up to 20MB. It will be compressed before upload. When editing, choose a new image to replace the old one.",
        "tour.cancel": "Cancel",
        "tour.saveMoment": "Save moment",
        "tour.mapArea": "Area map",
        "tour.closeMap": "Close map",
        "tour.openMap": "Open map",
        "tour.moreActions": "Open action menu",
        ...
        "toast.passwordResetSent": "Password reset email sent. Please check your inbox.",
        ...
        "toast.avatarMax": "Original avatar size is limited to 20MB.",
        ...
        "toast.photoMax": "Original image size is limited to 20MB.",
        "confirm.deleteMoment": "Delete this moment?",
        "confirm.deleteForumThread": "Delete this topic?",
        ...
        "auth.error.resetEmailRequired": "Enter your account email before resetting the password.",
...
const STATIC_BINDINGS = [
    ...
    { selector: ".home-mobile-logout span, .profile-mobile-logout", key: "nav.logout" },
    ...
    { selector: "#event-photo-submit", html: '<i class="ph ph-paper-plane-tilt"></i> Dang chu de', key: "events.postPhoto" },
    ...
    { selector: 'label[for="event-forum-category"]', key: "events.categoryLabel" },
    ...
    { selector: '[data-forum-category="all"]', key: "events.category.all" },
    { selector: '[data-forum-category="event"]', key: "events.category.event" },
    { selector: '[data-forum-category="question"]', key: "events.category.question" },
    { selector: '[data-forum-category="club"]', key: "events.category.club" },
    { selector: '[data-forum-category="notice"]', key: "events.category.notice" },
    { selector: '#event-forum-category option[value="event"]', key: "events.category.event" },
    { selector: '#event-forum-category option[value="question"]', key: "events.category.question" },
    { selector: '#event-forum-category option[value="club"]', key: "events.category.club" },
    { selector: '#event-forum-category option[value="notice"]', key: "events.category.notice" },
    ...
    { selector: "#forgot-password-btn", key: "auth.forgotPassword" },
    ...
    { selector: "#tour-action-menu-toggle", attr: "aria-label", key: "tour.moreActions" },
...
const ROUTE_EN = {
    ...
    "v-vb": {
        ...
        dialog: "Now I have both major academic landmarks in zone V. I can move on to the main gate of zone K."
    },
    "k-cong": {
        title: "Zone K Main Gate",
        shortTitle: "Main Gate",
        reward: "+15 new zone",
        body: "The zone K main gate marks the move from zone V into the broader campus area. It is a useful anchor before heading toward the Administration Center and academic buildings.",
        notes: [
            "The main entrance helps viewers orient from Tran Dai Nghia Street into zone K.",
            "It works well as a meeting point or a starting point for classes in zone K.",
            "From here, the route can continue to the Administration Center, lecture halls, and sports area."
        ],
        mission: "Identify the direction from the zone K main gate to the Administration Center.",
        dialog: "Zone K starts at the main gate. Before going deeper inside, I will use the gate as the anchor for reading the full map."
    },
    "k-hanh-chinh": {
    ...
    "k-d1-t1-khmt": {
        ...
        mission: "Observe floor 1 of building D and remember the main walkway, classrooms, or office areas that are easy to recognize.",
        dialog: "I am on floor 1 of building D. I will use the lobby area, hallway, and room signs as anchors before moving to the next floor."
    },
    "k-d1-t2-ktmt": {
        ...
        mission: "Explore floor 2 of building D and identify notable functional rooms or practice areas.",
        dialog: "Floor 2 of building D continues the indoor route. I will pay attention to room signs and the hallway axis so the path stays clear."
    },
    "k-d1-t3-kts-tmdt": {
        ...
        mission: "Complete the floor 3 survey of building D and find an anchor for returning to the lower floors.",
        dialog: "I have reached floor 3 of building D. Now I can connect the anchors from floors 1 to 3 before heading back down and continuing the route."
    },
    "k-e": {
